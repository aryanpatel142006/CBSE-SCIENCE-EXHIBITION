...
firebase_config = {
    "apiKey": "AIzaSyBO9wywsgDz3pYDTQmCyXDX2xIcsl36y9Y",
    'authDomain': "cbse-project-f451e.firebaseapp.com",
    'projectId': "cbse-project-f451e",
    "databaseURL": "https://cbse-project-f451e-default-rtdb.firebaseio.com/",
    'storageBucket': "cbse-project-f451e.appspot.com",
    'messagingSenderId': "662784014905",
    'appId': "1:662784014905:web:6d3e43f70cef2a6d026be8",
    'measurementId': "G-ZTSSHQ1JGN"
}
...
def easy(number):
    def speaking():
        ...
        speak(a)
        newvoicerate = 10
        speaking.setproperty('rate',newvoicerate )
    ...
    Button(win, text="Speak Question", font=("Arial", 30), command=speaking, cursor="hand").pack(pady=20, side="left")
