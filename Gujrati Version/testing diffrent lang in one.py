...
def easy(number):
    ...
    win.title('QUIZ')
    win.configure(background="#82E0AA")
...
Button(win,text='USE ENGLISH',font=("Arial", 40),command=use_english,cursor = "hand").pack(pady=20, side="right")
Button(win,text='USE HINDI',font=("Arial", 40),command=use_hindi,cursor = "hand").pack(pady=20,side="right")
...
if check[-1]:
    ...
    Button(win2, text='Speak Score', font=("Arial", 45), command=paper_score).pack(pady=0,side = "left")
